    ...
    <div class="layui-fluid">
        <form class="layui-form" action="">
                ...
                <div class="layui-form-item layui-row">
                    ...
                    <div class="layui-col-md4">
                        ...
                        <div class="layui-btn-group">
                            ...
                            <button class="layui-btn">删除资料</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-card">
                <div class="layui-card-header">文档资料</div>
                <div class="layui-card-body">
                    <div class="layui-btn-group">
                        <button class="layui-btn">规章</button>
                        <button class="layui-btn">非正常</button>
                        <button class="layui-btn">故障处理</button>
                        <button class="layui-btn">文件处理</button>
                    </div>
                </div>
            </div>

            <div class="layui-card">
                <div class="layui-card-header">微课资料</div>
                <div class="layui-card-body">
                    <div class="layui-btn-group">
                        <button class="layui-btn">故障处理</button>
                        <button class="layui-btn">非正常</button>
                        <button class="layui-btn">文件视频</button>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-group">
                        <button class="layui-btn">LKJ培训</button>
                        <button class="layui-btn">人身安全培训</button>
                    </div>
                </div>
            </div>
        </form>
